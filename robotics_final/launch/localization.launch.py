...
def generate_launch_description():
    ...
    amcl_config_file = os.path.join(bringup_dir, 'config', 'amcl_config.yaml')
    ...
    map_yaml_arg = DeclareLaunchArgument(
        ...
        description='Full path to map YAML to be loaded by map_server'
    )

    use_sim_time_arg = DeclareLaunchArgument(
        'use_sim_time',
        default_value='true',
        description='Enable use of simulated clock'
    )
    ...
    frame_id_converter_node = Node(
        ...
        executable='laser_frame_adapter.py',
    ...
    ekf_diff_imu_node = Node(
        package='robotics_final',
        executable='sensor_fusion_odom.py',
    ...
    # Return items: order rearranged slightly for readability; functionality
    # (what nodes are launched) is unchanged.
